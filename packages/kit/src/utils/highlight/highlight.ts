/**
 * https://github.com/riccardoperra/codeimage/blob/main/apps/codeimage/src/core/directives/highlight.ts
 */
import { createEffect, onMount } from "solid-js";
import { highlightBlock } from "./highlight.css";
...
export function highlight(el: HTMLElement, text: () => string): void {
	...
	function prepareHighlightEl(): HTMLElement {
		...
		highlight.classList.add(highlightBlock);
